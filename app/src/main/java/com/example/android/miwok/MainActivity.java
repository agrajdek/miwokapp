...
//        LinearLayout numbersView = (LinearLayout) findViewById(R.id.numbers);
        ...
        for (int index = 0; index < englishNumbers.size(); index++) {
            ...
            wordView.setText(englishNumbers.get(index).get);
//            numbersView.addView(wordView);
        }

        ArrayAdapter<Word> itemsAdapter = new ArrayAdapter<Word>(this, R.layout.item_list, englishNumbers);
